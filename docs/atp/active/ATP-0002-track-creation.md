...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | `REQ-TRK-001` | Create TD-02 in a workspace without TD-03. | One contained track is created with lifecycle `DRAFT` and workflow ID/version. | A temporary track was created as `DRAFT` with workflow `suno-track` `1.1`. | PASS | Rust `track_creation_builds_exact_folders` |
