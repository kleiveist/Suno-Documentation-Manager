...
| 5 | Local Suno Terms import | Manifest/PDF retain source metadata, path, provenance, size, import time, and full hash | Persistence round-trip, manifest model, and PDF terms fixture implemented | PASS | Rust metadata migration/round-trip and PDF terms fixture |
