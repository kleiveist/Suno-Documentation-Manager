...
const SUPPLEMENTAL_TRANSLATIONS: readonly Translation[] = [
  ...
  ["Dies dokumentiert technische externe Zeitstempelnachweise. sunodm trifft keine rechtliche Einordnung des Zeitstempels.", "This records technical external timestamp evidence. No legal qualification of the timestamp is determined by sunodm."],
