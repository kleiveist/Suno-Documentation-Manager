...
export type SunoContentClassification = "STRUCTURE_ONLY" | "VOCAL_LYRICS_ONLY" | "MIXED" | "EMPTY" | "OTHER";
...
export type SunoLyricsContentType =
  "vocal_lyrics" | "structure_instructions" | "sound_instructions" | "arrangement_instructions" | "mixed" | "other";
...
export type TimestampProviderKind =
  "disabled" | "free_tsa" | "open_timestamps" | "sigstore_public_tsa" | "custom_rfc3161";
...
export type AudioScreeningProviderStatus =
  "disabled" | "not_configured" | "ready" | "authentication_failed" | "provider_unavailable" | "configuration_invalid";
...
export type TrackFieldPatch = Partial<Omit<TrackFields, "sunoLyricsFieldContent" | "sunoLyricsContentTypes">>;
