...
TRACEABILITY: dict[str, tuple[str, ...]] = {
    ...
    "LC-016": (
        "tools/tests/template_lifecycle/test_generation.py::test_every_profile_gets_valid_deterministic_lifecycle_metadata",
        "tools/tests/test_ci_workflows.py::test_core_ci_matches_the_desktop_local_product_profile",
    ),
    "LC-017": (
        "tools/tests/template_lifecycle/test_status.py::test_status_with_local_source_and_verify_are_offline",
    ...
    "LC-020": (
        "tools/tests/test_ci_workflows.py::test_ci_checks_the_declared_rust_msrv_without_weakening_the_quality_toolchain",
        "tools/tests/test_ci_workflows.py::test_product_owns_only_applicable_workflows",
        "tools/tests/test_ci_workflows.py::test_release_workflow_validates_sunodm_without_signing_or_publication",
        "tools/tests/test_ci_workflows.py::test_workflows_use_exact_v1_0_3_action_pins_and_no_external_authority",
    ),
}
